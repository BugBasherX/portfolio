...
const projects: Project[] = [
  ...
  },
  {
    ...
    skills: {
      frontend: [
        ...
        PROJECT_SKILLS.next,
        PROJECT_SKILLS.chakra,
        PROJECT_SKILLS.PythonAnywhere, PROJECT_SKILLS.react,
      ],
      backend: [
        PROJECT_SKILLS.node,
        PROJECT_SKILLS.express,
    ...
    get content(): JSX.Element {
      return (
        <div>
          ...
          <p className="font-mono mb-2">
            Powered by PythonAnywhere, this bad boy allows us to keep the content
  ...
  },
  {
    ...
    skills: {
      frontend: [PROJECT_SKILLS.js, PROJECT_SKILLS.PythonAnywhere, PROJECT_SKILLS.react],
      backend: [
        PROJECT_SKILLS.node,
